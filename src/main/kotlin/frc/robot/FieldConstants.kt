...
object FieldConstants {
	...
	object Poses {
		...
		val AT_L1_LEFT_AB = Pose2d(3.21060, 4.43458, Rotation2d.fromDegrees(0.0))
		val AT_L1_RIGHT_AB = Pose2d(3.21060, 3.61726, Rotation2d.fromDegrees(0.0))
		val AT_L1_LEFT_CD = Pose2d(3.49606, 3.12283, Rotation2d.fromDegrees(60.0))
		val AT_L1_RIGHT_CD = Pose2d(4.20388, 2.71417, Rotation2d.fromDegrees(60.0))
		val AT_L1_LEFT_EF = Pose2d(4.77480, 2.71417, Rotation2d.fromDegrees(120.0))
		val AT_L1_RIGHT_EF = Pose2d(5.48261, 3.12283, Rotation2d.fromDegrees(120.0))
		val AT_L1_LEFT_GH = Pose2d(5.76807, 3.61726, Rotation2d.fromDegrees(180.0))
		val AT_L1_RIGHT_GH = Pose2d(5.76807, 4.43458, Rotation2d.fromDegrees(180.0))
		val AT_L1_LEFT_IJ = Pose2d(5.48261, 4.92901, Rotation2d.fromDegrees(-120.0))
		val AT_L1_RIGHT_IJ = Pose2d(4.77480, 5.33767, Rotation2d.fromDegrees(-120.0))
		val AT_L1_LEFT_KL = Pose2d(4.20388, 5.33767, Rotation2d.fromDegrees(-60.0))
		val AT_L1_RIGHT_KL = Pose2d(3.49606, 4.92901, Rotation2d.fromDegrees(-60.0))
