...
object JointedElevatorConstants {
	...
	val L2_ELEVATOR_ROTATION = 0.8498.rotations
	val L3_ELEVATOR_ROTATION = 1.6044.rotations
	...
	val L3_ANGLE = Rotation2d.fromDegrees(-43.15)
	val L4_ANGLE = Rotation2d.fromDegrees(-38.32)
